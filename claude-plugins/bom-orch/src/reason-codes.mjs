 ...
 *   | `proof` | 끝난 실행의 후보 하나를 **다시 돌려** 회귀를 증명하는 경로(WS9 `orch_prove`) — 고칠 상태는 실행이 아니라 재현의 전제(baseline·환경·후보·델타)와 그 기록이다 | `proof_run_not_found` `proof_environment_drift` `proof_candidate_mismatch` |
 *
